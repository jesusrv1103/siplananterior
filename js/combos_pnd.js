function llena_combo_objetivo(pnd_eje) {
    ...
    document.getElementById('pnd_objetivo').options[0] = new Option('-Seleccione-', '');
    document.getElementById('pnd_estrategia').length = 0;
    document.getElementById('pnd_estrategia').options[0] = new Option('-Seleccione-', '');
    document.getElementById('pnd_linea').length = 0;
    document.getElementById('pnd_linea').options[0] = new Option('-Seleccione-', '');
