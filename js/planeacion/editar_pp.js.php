...
function validar(){
    ...
    if( $('#objetivo').val().lenght < 8 ){ alert('error en el objetivo'); return false;}
...
function guardar(){
    ...
    if($('#prioritario').prop('checked')){ var prioritario = 1; } else { var prioritario = 0;}
    if(validado){
