...
<table>
  <tr bgcolor="#669900">
    <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">SECTOR</div></td>
	 ...
	 <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">No.PROY</td>
     <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">PROYECTO</td>
     <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">No.COMP</td>
     <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">COMPONENTE</td>
     <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">OBJETIVO</td>
     ...
     <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">DIMENSION</td>
     ...
     <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">U MEDIDA</td>
     <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">META</td>
          <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">SUPUESTO</td>
               <td style="border-bottom: solid 1px #C4D79B;"><div style="color:#ffffff;">VERIFICA</td>
  </tr>
  <?php while($res_consulta = mysql_fetch_array($ejecuta_consulta)) { 
	...
	$contador = $contador+1;
  	?>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['sector'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['dependencia'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['num_proyecto'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['proyecto'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['componente'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['descripcion'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['objetivo'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['nombre'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['metodo'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['tipo'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['dimension'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['frecuencia'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['sentido'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['u_medida'];?></td>
    <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['meta'];?></td>
        <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['supuesto'];?></td>
            <td style="border-bottom: solid 1px #C4D79B;"><?php echo $res_consulta['medio'];?></td>
  </tr>
  <?php } ?>
</table>
