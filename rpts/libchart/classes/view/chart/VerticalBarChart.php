<?php
    ...
    class VerticalBarChart extends BarChart {
        ...
        public function VerticalBarChart($width = 600, $height = 250) {
            ...
            $this->emptyToFullRatio = 1	 / 3	;  //1/5  cambie tamñao de barra
            $this->plot->setGraphPadding(new Padding(5, 30, 70, 50)); //5, 30, 50, 50
        }
        ...
        protected function printBar() {
            ...
            for ($j = 0; $j < $serieCount; $j++) {
				...
				//	imagefilledrectangle($img, $x1, $ymin, $x2, $graphArea->y2 - 1,  $color);
