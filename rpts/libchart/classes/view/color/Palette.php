    ...
    class Palette {
        ...
        public function Palette() {
         ...
         /* $this->setBarColor(array(
			...
			$this->setBarColor(array(colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore()));
           ...
           $this->setLineColor(array(
			...
			//$this->setLineColor(array(colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore()));
		...
		//	$this->setPieColor(array(colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore(), colore()));
        }
