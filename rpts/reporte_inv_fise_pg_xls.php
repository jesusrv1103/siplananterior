...
$pr=$_GET['pg'];
if ($pr==20){
	echo "Programa SC Agua Potable";
	}
elseif($pr==21){
	echo "Programa SD Alcantarillado";
	}
elseif($pr==24){
	echo utf8_decode("Programa SG Electrificación");
	}
elseif($pr==25){
	echo "Programa SH Vivienda Digna";
	}
elseif($pr==4){
        echo "Programa AB Albergue Comunitario";
        }
elseif($pr==35){
        echo "Programa SS Asistencia Social y Servicios Comunitarios";
        }
...
?>
   ...
   while ($r_con = mysql_fetch_array($ex_con)){
	   ...
	   AND obras.id_dependencia=12
	    AND obras.programa_poa=".$_GET['pg']."
