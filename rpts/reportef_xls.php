...
header("Content-Disposition: attachment; filename=AFF_PP_2018.xls");
...
<table border=0 cellpadding=0 cellspacing=0 width=3422 style='border-collapse:
 ...
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  height:22.5pt'>UCOORDINACIÓN ESTATAL DE PLANEACI&Oacute;N</td>
 </tr>
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
 ...
 <tr class=xl110 height=38 style='mso-height-source:userset;height:28.5pt'>
  ...
  <td rowspan=3 class=xl109 width=134 style='border-top:none;width:101pt'>DESCRIPCI&OacuteN
 ...
 <tr class=xl110 height=47 style='mso-height-source:userset;height:35.25pt'>
  ...
  <td rowspan=2 class=xl109 width=95 style='border-top:none;width:71pt'>EJE. L&Iacute;NEA ESTRAT&Eacute;GICA. ESTRATEGIA</td>
 </tr>
...
// SELECT * FROM localidades WHERE id_localidad = ".$row['localidad']
 ...
 $num_oficio="";
  ...
  $consultar_aproba = mysql_query("SELECT * FROM oficio_aprobacion  WHERE id_oficio = ".$rep_ofi['id_oficio']." AND oficio_aprobacion.activo ",$siplan_data_conn) or die (mysql_error());
...
$String = str_replace('\ED',"\CD",$String);
$String = str_replace('\E9',"\C9",$String);
$String = str_replace('\F3',"\D3",$String);
...
$String = str_replace('\CD',"\ED",$String);
$String = str_replace('\C9',"\E9",$String);
$String = str_replace('\D3',"\F3",$String);
