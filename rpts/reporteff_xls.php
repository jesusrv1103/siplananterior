...
header("Content-Disposition: attachment; filename=AFF_PP_todos_2018.xls");
...
<table border=0 cellpadding=0 cellspacing=0 width=3422 style='border-collapse:
 ...
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  height:22.5pt'>Avance de Ejercicio F&iacute;sico - Financiero <?php echo date("Y"); ?></td>
 </tr>
...
<td class=xl198>&nbsp;</td>
 ...
 <tr class=xl110 height=47 style='mso-height-source:userset;height:35.25pt'>
  ...
  L&Iacute;NEA ESTRAT&Eaute;GICA. ESTRATEGIA</td>
 </tr>
...
//original linea---  $sac_mun = mysql_query("SELECT * FROM municipios WHERE id_municipio = ".$row['municipio'],$siplan_data_conn) or die (mysql_error());
 ...
 //clave municipio
//linea antigua $cve_mun=$res_mun['id_municipio'];
...
$st_edo="Cancelada";	
 ...
 <tr class=xl144 height=17 style='height:12.75pt'>
  <td height=17 class=xl115 width=3422 style='height:12.75pt;width:53pt'><?php echo utf8_decode(limpiar($sector)); ?></td>
