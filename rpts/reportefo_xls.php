...
header("Content-Disposition: attachment; filename=AFF_PP_SEP_DIC_2018.xls");
...
<table border=0 cellpadding=0 cellspacing=0 width=3422 style='border-collapse:
 ...
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  height:22.5pt'>Cierre de Ejercicio Físico - Financiero 2018</td>
 </tr>
...
$st_edo="Cancelada";	
 ...
 <tr class=xl144 height=17 style='height:12.75pt'>
  ...
  <td class=xl66 width=90 style='border-left:none;width:68pt'><?php echo "$".number_format(($otros-$otros),2); ?></td>
