<?php 
$con = $conn->conectar(1);
$sql = $con->query("SELECT * FROM indicadores WHERE id_indicador = ".$_GET['id_indicador']);
$con->close();
unset($con);
$indicador = $sql->fetch_array();
?>
<div class="content-wrapper">
    <section class="content-header">
        <h1>SIPLAN 2019<br><small> Editar Indicador</small></h1>
    </section>
    <section class="content">
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title">Editar Indicador <?php echo $_GET['tipo']; ?> - <small><?php echo  $_SESSION['acronimo_dependencia']; ?> </small></h3>
            </div>
            <div class="box-body">


                <a href="javascript:window.history.back();" class="btn-sm btn-success">
                    <span class="glyphicon glyphicon-chevron-left"></span>&nbsp;Lista de Indicadores</a>
                    <hr>
                    <h4><span class="text text-success">Editar indicador</span></h4>
                    <form id="proyecto" name="proyecto" method="post" role="form" onsubmit="return guardar();">
                        <div class="form-group">
                            ...
                            <input type="text" id="nombre" name="nombre" class="form-control"  required value="<?php echo $indicador[5]; ?>">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="definicion">Definición del Indicador</label>
                                    <textarea rows="18" id="definicion" name="definicion" class="form-control" required><?php echo $indicador[6]; ?></textarea>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-4">
               <div class="form-group">
                ...
                <input type = "text" required class="form-control" id="u_medida" name="u_medida" value="<?php echo $indicador[12]; ?>">
            </div>
        </div>
        <div class="col-md-4">
           <div class="form-group">
            <label for="nombre">Meta</label>
            <input type="number" id="meta" name="nombre" class="form-control" step=0.001  required value="<?php echo $indicador[13]; ?>">
        </div>
    </div>
    <div class="col-md-4">
       <div class="form-group">
        <label for="nombre">Línea Base</label>
        <input type="number" id="linea_base" name="linea_base" class="form-control" step=0.001 required value="<?php echo $indicador[14]; ?>">
    </div>
</div>
</div>
<div class="row">
    <div class="col-md-6">
        ...
        <div class="form-group" id="variables">
            ...
            <input type="text" id="verifica" name="verifica" class="form-control"  required value="<?php echo $indicador[15]; ?>">
        </div>
    </div>
    <div class="col-md-6">
      <div class="form-group" id="variables">
        <label>Supuesto</label>
        <input type="text" id="supuesto" name="supuesto" class="form-control"  required value="<?php echo $indicador[16]; ?>">
    </div>
</div>
</div>
